...
INSERT INTO address (id, base, house_number, home_unit)
VALUES (2, 'Tehran', '1', '1');
INSERT INTO node (id, full_name, phone_number, address_id, comment, dtype, x, y)
VALUES (1, 'Farid Masjedi', '09339018022', 1, 'sample comment', 'source_node', 1.0, 1.0);
INSERT INTO box_order (id, client_id, source_node_id, order_type, creation_date, last_modified_date, price)
VALUES (1, 1, 1, 'BIKE', NOW(), NOW(), 40000.0);
...
INSERT INTO node (id, full_name, phone_number, address_id, comment, dtype, x, y)
VALUES (3, 'Navid Masjedi', '09339018022', 3, 'sample comment', 'source_node', 3.0, 3.0);
INSERT INTO box_order (id, client_id, source_node_id, order_type, creation_date, last_modified_date, price)
VALUES (2, 1, 2, 'CAR', NOW(), NOW(), 40000.0);
INSERT INTO node (id, full_name, phone_number, address_id, comment, price_range, box_order_id, dtype, x , y)
